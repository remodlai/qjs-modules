 ...
 string(REGEX REPLACE "_" "-" FILE "try-${NAME}.c")
  ...
  if(NOT DEFINED "${RESULT_VAR}")
    ...
    try_compile(
      ...
      "-DINCLUDE_DIRECTORIES=${QUICKJS_SOURCES_ROOT}"
      "-DLINK_DIRECTORIES=${QUICKJS_LIBRARY_DIR}"
...
function(compile_module SOURCE)
  ...
  add_custom_target(
    ...
    COMMAND "${QJSC}" ${ADD_MODULES} -o "${OUTPUT_FILE}" -m "${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE}"
    DEPENDS ${QJSC_DEPS}
